...
\firstname{Pavlo} \lastname{Svirin}\inst{1}
\firstname{Kaushik} \lastname{De}\inst{2}
\firstname{Alessandra} \lastname{Forti}\inst{3}
\firstname{Alexei} \lastname{Klimentov}\inst{1}
\firstname{Rasmus} \lastname{Larsen}\inst{1}
\firstname{Peter} \lastname{Love}\inst{4}
\firstname{Tadashi} \lastname{Maeno}\inst{1}
\firstname{Ruslan} \lastname{Mashinistov}\inst{1}
\firstname{Swagato} \lastname{Mukherjee}\inst{1}
\firstname{Andrei} \lastname{Nomerotski}\inst{1}
\firstname{Danila} \lastname{Oleynik}\inst{2}
\firstname{Sergey} \lastname{Panitkin}\inst{1}
\firstname{Heyun} \lastname{Park,}\inst{1}{5}
\firstname{Erin} \lastname{Sheldon}\inst{1}
\firstname{Anze} \lastname{Slosar}\inst{1}
\firstname{Jack} \lastname{Wells }\inst{6}
